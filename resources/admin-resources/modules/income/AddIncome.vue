        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="form-item">
                            <label class="my-2">আয়ের সংক্ষিপ্ত বিবরন</label>
                            <p
                                class="text-danger"
                        ...
                        <div class="form-item">
                            <label class="my-2">আয়ের ধরন</label>
                            <p
                                class="text-danger"
                        ...
                        <div class="form-item">
                            <label class="my-2">আয়ের তারিখ</label>
                            <p
                                class="text-danger"
                        ...
                        <div class="form-item">
                            <label class="my-2">আয়ের পরিমাণ</label>
                            <p
                                class="text-danger"
